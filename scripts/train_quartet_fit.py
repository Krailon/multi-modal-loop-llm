"""Train the bounded single-arrangement quartet fitting diagnostic."""
...
from multimodal_loop.data.quartet_fit import QuartetFitDataset, parse_quartet_fit
...
def main():
    ...
    parser.add_argument("--evaluation-interval", type=int, default=54)
    parser.add_argument(
    ...
    try:
        ...
        manifest = parse_quartet_fit(args.manifest.read_text())
        ...
        validate_fit_protocol(manifest, config, training, budget, smoke=args.smoke)

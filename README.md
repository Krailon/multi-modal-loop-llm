...
> did not resolve size-dependent confusion. The proposed next decision is a small,
> balanced training-fit sanity check with the unchanged model; its protocol is not
> yet specified.
